...
public class RulesWindow {
	...
	private void initialize() {
		...
		JLabel lblMissionFindAll = new JLabel(
				"MISSION: Find all missing pieces of your spacebus so your crew can make it back home");
		...
		JLabel lblWatchHunger = new JLabel(
				"5. Watch hunger and tiredness levels. Each day health gets adjusted based on these");
